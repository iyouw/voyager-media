...
var Module = typeof ffm != 'undefined' ? ffm : {};
...
["_main","__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_hello_wasm","_open_store","_ensure_store_write_capacity","_did_write_store","_close_store","_open_demuxer","_close_demuxer","_open_decoder","_decode","_close_decoder","_fflush","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
// end include: preamble.js
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('trancode.worker.js');
  ...
  function ___syscall_connect(fd, addr, addrlen) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(6, 1, fd, addr, addrlen);
  ...
  function ___syscall_faccessat(dirfd, path, amode, flags) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(7, 1, dirfd, path, amode, flags);
  ...
  function ___syscall_getsockname(fd, addr, addrlen) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(12, 1, fd, addr, addrlen);
  ...
  function ___syscall_getsockopt(fd, level, optname, optval, optlen) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(13, 1, fd, level, optname, optval, optlen);
  ...
  function ___syscall_ioctl(fd, op, varargs) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(14, 1, fd, op, varargs);
  ...
  function ___syscall_listen(fd, backlog) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(15, 1, fd, backlog);
  ...
  function ___syscall_lstat64(path, buf) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(16, 1, path, buf);
  ...
  function ___syscall_mkdirat(dirfd, path, mode) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(17, 1, dirfd, path, mode);
  ...
  function ___syscall_newfstatat(dirfd, path, buf, flags) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(18, 1, dirfd, path, buf, flags);
  ...
  function ___syscall_openat(dirfd, path, flags, varargs) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(19, 1, dirfd, path, flags, varargs);
  ...
  function ___syscall_poll(fds, nfds, timeout) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(20, 1, fds, nfds, timeout);
  ...
  function ___syscall_recvfrom(fd, buf, len, flags, addr, addrlen) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(21, 1, fd, buf, len, flags, addr, addrlen);
  ...
  function ___syscall_renameat(olddirfd, oldpath, newdirfd, newpath) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(22, 1, olddirfd, oldpath, newdirfd, newpath);
  ...
  function _fd_fdstat_get(fd, pbuf) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(31, 1, fd, pbuf);
  ...
  function _fd_read(fd, iov, iovcnt, pnum) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(32, 1, fd, iov, iovcnt, pnum);
  ...
  function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(33, 1, fd, offset_low, offset_high, whence, newOffset);
  ...
  function _getaddrinfo(node, service, hint, out) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(35, 1, node, service, hint, out);
...
/** @type {function(...*):?} */
var _hello_wasm = Module["_hello_wasm"] = createExportWrapper("hello_wasm");
/** @type {function(...*):?} */
var _open_store = Module["_open_store"] = createExportWrapper("open_store");
/** @type {function(...*):?} */
var _ensure_store_write_capacity = Module["_ensure_store_write_capacity"] = createExportWrapper("ensure_store_write_capacity");
/** @type {function(...*):?} */
var _did_write_store = Module["_did_write_store"] = createExportWrapper("did_write_store");
/** @type {function(...*):?} */
var _close_store = Module["_close_store"] = createExportWrapper("close_store");
/** @type {function(...*):?} */
var _open_demuxer = Module["_open_demuxer"] = createExportWrapper("open_demuxer");
/** @type {function(...*):?} */
var _close_demuxer = Module["_close_demuxer"] = createExportWrapper("close_demuxer");
/** @type {function(...*):?} */
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 1267180;
